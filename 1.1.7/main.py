...
# ========== Generación ==========
def generar_pdf(nombre_pdf="Rifa_Hermosillo.pdf"):
    ...
    random.shuffle(all_numbers)  # Mezcla los números para selección aleatoria sin repetición
    idx = 0
    block_id = 1
    ...
    for _ in range(total_hojas):
        ...
        for col in range(COLUMNAS):
            for b in range(BLOQUES_POR_COLUMNA):
                ...
                idx += 4
                y_block_top = y_top_page - b * block_height - 10 * mm # mueve 1cm los numeros hacia abajo
